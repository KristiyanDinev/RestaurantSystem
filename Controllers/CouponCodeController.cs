...
namespace RestaurantSystem.Controllers
{
    ...
    public class CouponCodeController : Controller
    {
            ...
            [FromForm] decimal Total)
        {
            ...
            decimal finalTotal = _couponService.HandleCouponDiscount(code.DiscountPercent, Total);
            
            TempData["CouponDiscount"] = code.DiscountPercent;
            TempData["CouponTotal"] = finalTotal.ToString();
            TempData["CouponCode"] = CouponCode;
            
            return Ok(new
            {
                discountPercentage = code.DiscountPercent,
